...
def static "common.CommonUtils.openNewTab"() {
    (new common.CommonUtils()).openNewTab()
}
...
/**
	 ...
	 * @return
	 */
def static "common.CommonUtils.roundDecimals"(
    	float d	
     , 	int decimalPlace	) {
    (new common.CommonUtils()).roundDecimals(
        	d
         , 	decimalPlace)
}
