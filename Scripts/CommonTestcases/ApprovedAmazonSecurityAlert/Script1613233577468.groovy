...
WebUI.callTestCase(findTestCase('CommonTestcases/LoginGmail'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.comment('Open Inbox')
...
WebUI.click(findTestObject('Gmail/ApproveOrDecline/a_AprrovedOrDeny'))

WebUI.switchToWindowIndex(2)

WebUI.waitForElementPresent(findTestObject('Gmail/ApproveOrDecline/button_Approved'), 10)
